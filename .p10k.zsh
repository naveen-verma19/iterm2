# Generated by Powerlevel10k configuration wizard on 2025-05-04 at 12:15 IST.
...
() {
  ...
  # nverma  FOR regular triangle symbol (change angle of left prompt) typeset -g POWERLEVEL9K_LEFT_PROMPT_LAST_SEGMENT_END_SYMBOL='\uE0B0'
  #FOR FIRE symbol
  ...
  # Default current directory foreground color. (nverma make it dark)
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=#2d2e36
  # If directory is too long, shorten some of its segments to the shortest possible unique
  # prefix. The shortened directory can be tab-completed to the original.
  typeset -g POWERLEVEL9K_SHORTEN_STRATEGY=truncate_to_unique
  # Replace removed segment suffixes with this symbol.
  typeset -g POWERLEVEL9K_SHORTEN_DELIMITER=
  # Color of the shortened directory segments. (like /home/user/projects/my-awesome-project, it might show as /h/u/p/my-awesome-project nverma)
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=#2d2e36
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor. (nverma make it dark)
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=#2d2e36
  # Display anchor directory segments in bold. (nverma don't want bold)
